...
import com.example.ekqi.mysearchfilm.R;
...
import de.hdodenhof.circleimageview.CircleImageView;
 ...
 public class DetailActivity extends AppCompatActivity{
     ...
     public static String EXTRA_BACKCOVER    = "extra_backcover";
     public static String EXTRA_RATE_COUNT   = "extra_rate_count";
     public static String EXTRA_RATE         = "extra_rate";

     private TextView tvJudul, tvOverview, tvReleaseDate, tvRating, tvLang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvLang = (TextView)findViewById(R.id.detailLang);
        imgPoster = (ImageView)findViewById(R.id.imgfilmbg);
        imgFilm = (CircleImageView)findViewById(R.id.imgFilm);
        ...
        String cover_jpg = getIntent().getStringExtra(EXTRA_BACKCOVER);
        ...
        Picasso.with(context).load("http://image.tmdb.org/t/p/w342/"+poster_jpg).into(imgPoster);
        Picasso.with(context).load("http://image.tmdb.org/t/p/w342/"+cover_jpg).into(imgFilm);
    }
}
